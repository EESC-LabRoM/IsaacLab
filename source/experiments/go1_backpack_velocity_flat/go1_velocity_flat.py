...
UNITREE_GO1_CFG = ArticulationCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        usd_path="omniverse://localhost/Library/go1_description/go1.usd", #f"{ISAACLAB_NUCLEUS_DIR}/Robots/Unitree/Go1/go1.usd",#"omniverse://localhost/Library/go1_sensors/go1_sensors1.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_vel={
            ".*L_hip_joint": 0.,
            ".*R_hip_joint":0.,
            "F[L,R]_thigh_joint":0.,
            "R[L,R]_thigh_joint":0.,
            ".*_calf_joint":0.,
        },
    ),
...
class ActionsCfg:
    ...
    joint_pos = mdp.JointPositionActionCfg(
        asset_name="robot", joint_names=[".*_hip_joint", ".*_thigh_joint",".*_calf_joint"], scale=0.25, use_default_offset=True
    )
